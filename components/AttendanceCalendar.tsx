    ...
    if (!subject.schedule || subject.schedule.length === 0) {
        return (
            <div className="text-center py-10 px-4">
                ...
                <h3 className="mt-2 text-lg font-medium text-gray-900">Horario no definido</h3>
                <p className="mt-1 text-sm text-gray-500">Por favor, establece un horario para esta materia para poder gestionar la asistencia.</p>
            </div>
        );
    }
